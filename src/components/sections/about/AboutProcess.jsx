      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-40">
          {storyItemsData.map((item, index) => {
            ...
            const headingId = `story-heading-${index}`;
            const detailsId = `story-details-${index}`;
                ...
                <div className="md:w-1/2 text-center md:text-left mx-10">
                  ...
                  >
                    <div className="overflow-hidden">
                      <p className="text-gray-500 font-light text-base leading-relaxed pt-2 mb-8">
                  ...
                  <button
                    ...
                    className="px-8 py-3 border border-gray-300 text-gray-600 font-sans text-sm font-semibold tracking-widest hover:bg-brand-dark-brown hover:text-white hover:border-brand-dark-brown transition-colors duration-300"
